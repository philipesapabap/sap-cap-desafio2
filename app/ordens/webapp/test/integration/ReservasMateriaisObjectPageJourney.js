...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ReservasMateriaisObjectPageObjectPage journey");

        opaTest("Navigate to ReservasMateriaisObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheOrdensObjectPage.onTable({ property: "reservas" }).iCheckRows();
